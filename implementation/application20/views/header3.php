...
<div class="newheader">
    ...
    <nav class="navbar nabvar-default" id="navlink">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav nav-pills " id="" style="text-align: center">
                <li ><a href="#"  class="link1">Classes</a></li>
    ...
    <button class="btn success btn-lg " id="techBtn1">
        ...
        <span class=" glyphicon glyphicon-plus-sign course " data-toggle="tooltip1" data-original-title="Create Class"></span>
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a href="http://localhost/SPL/index.php/settings/teacher_settings" target="_blank">Setting</a></li>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding:40px 50px;">
                    <form role="form" action="http://localhost/SPL/index.php/teacher/create_group" method="post">
                        ...
                        <div class="form-group">
                            <label for="psw"><span class="glyphicon glyphicon-pencil"></span> Semister</label>
                            <input type="text" name="semister" class="form-control" id="psw" placeholder="Enter Semister" required>
                        </div>

                        <button type="submit" class="btn btn-success btn-block" onclick="send_data()"><span class="glyphicon glyphicon-off"></span> Submit</button>
                    </form>
                </div>
                <div class="modal-footer">
