    ...
    <style type="text/css">
    	body{
           ...
           width: 100%;
            position: ;
           /* top: 50px;*/
			/*background-image: url("http://localhost/SPL/assets/assignment.png");*/
            background-image: url("http://localhost/SPL/assets/assignment.jpg");
...
<body>
	<div class="header">
        ...
        <div class="about">
            ...
            <a href="http://localhost/SPL/index.php/about_Devloper" data-toggle="tooltip" title="About" id="About"><span class="glyphicon glyphicon-info-sign"></span></a>
            <a href="http://localhost/SPL/index.php/gethelp" data-toggle="tooltip1" title="Quick Help" id="help"><span class="glyphicon glyphicon-question-sign"></span></a>
	   ...
	   <div class="container">
           ...
           <!--<div class="header">
	   	  ...
	   	  <div class="row">
	   	  	...
	   	  	<div class="col-md-4">
	   	  		<div class="loginBox" >
	                <img src="http://localhost/SPL/assets/user.png" class="userPic img-responsive">

                    <h2 id="para" >Sign in Here</h2>
                    <p id="error"></p>
	                <form class="formDecorator" method="post" action="http://localhost/SPL/index.php/UserLogin">
                    ...
                    <div class="form-group inner-addon left-addon">
  					...
  					<div class="form-group">
  					<a href="http://localhost/SPL/index.php/login/reset_password" style="color: Maroon" >Forgot password?</a>
  				   </div>
  				   <div class="form-group">
  					  Do not have account? <a href="http://localhost/SPL/index.php/Register" style="color: Maroon;font-size: 15px;" ><b> Sign up</b></a>
  				   </div>
				</form>
