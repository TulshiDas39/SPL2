                  ...
                  <div class="modal-body" style="padding:40px 50px;">
                      <form role="form">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="usrname" placeholder="Enter Course name" required>
                          </div>
                          <div class="form-group">
                              <label for="psw"><span class="glyphicon glyphicon-pencil"></span> Semister</label>
                              <input type="text" class="form-control" id="psw" placeholder="Enter Semister" required>
                          </div>
                  ...
                  <div class="modal-body" style="padding:40px 50px;">
                      <form role="form">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="usrname" placeholder="Enter group code" required>
                          </div>
