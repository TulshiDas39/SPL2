...
<?php $i=0;$assignment=0; $is_submitted=0;
    ...
    <div class="mydiv">
       ...
       <div class="text-right">
            <button id = "<?php echo $post->post_id; ?>" class="btn btn-success" onclick=" upload(this.id)/*document.getElementById('file').click(); document.getElementById('post_id').value= this.id;*/"><?php echo $button[$assignment] ?></button>
        </div>
        <?php $assignment++; }?>
