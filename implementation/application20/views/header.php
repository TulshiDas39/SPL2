...
<div  class="newheader">
    ...
    <nav class="navbar nabvar-default" id="navlink">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav nav-pills " id="">
                <li ><a href="#" class="link1"onclick="show_allPosts()">Streams</a></li>
                <li><a href="#" class="link2" onclick="show_classmates(<?php echo $group_id?>)">Students</a></li>
                <li><a href="#" class="link3" onclick="show_about(<?php echo $group_id?>)">About</a></li>
            </ul>
        </div>
    ...
    <div class="dropdown1">
       <!-- <button class="btn btn-circle dropdown-toggle" id="notification_button" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="notification_button" id="menu_div">
            ...
            <li><a style=""class="dropdown-item" href=""><small><i>2 february</i></small><br/></a></li>
    ...
    <div class="dropdown3">
        ...
        <ul class="dropdown-menu">
            <li><a href="http://localhost/SPL/index.php/settings/teacher_settings">Setting</a></li>
                ...
                <div class="modal-dialog" id="menu-modal">
                    <div class="modal-content" id="menu-content">
                        ...
                        <div class="modal-footer">
                            <a href="http://localhost/SPL/index.php/settings/teacher_settings" class="footer-content">
                    ...
                    <div class="modal-dialog" id="post_modal">
                        <div class="modal-content" id="post_content">
                            ...
                            <div class="modal-body">
                                ...
                                <textarea type="text" placeholder="Topic" id="topic" name="topic" required></textarea>
                                <textarea type="text" placeholder= "Post description" id="share" name="share_post" required ></textarea>
                                <span id="file_text1">No flie choosen yet

                                </span>
                                <p style="display: none" id ="file_attached1">0</p>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-primary" id="post_btn" onclick="store_attachment(0);">Post</button>
                    ...
                    <div class="modal-dialog" id="assign_modal">
                        <div class="modal-content" id="assign_content">
                            ...
                            <div class="modal-header" id="assign_header">
                                <button  class="close" data-dismiss="modal" id="cross1">&times;</button>
                            ...
                            <div class="modal-body">
                                ...
                                <textarea type="text" placeholder="Title" id="topic1" name="title" required></textarea>
                                <textarea type="text" placeholder= "Instructions" id="share1" name="instructions" required></textarea>
                                        ...
                                        <div class='col-sm-6'>
                                            <div class="form-group">
                                                <div class='input-group date' id='datetimepicker1'>
                                                    ...
                                                    <input type='text' class="form-control" required name="date" id = "submission_date" />
                                        ...
                                        <div class='col-sm-6'>
                                            <div class="form-group">
                                                <div class='input-group date' id='datetimepicker3'>
                                                    <input type='text' class="form-control" required name="time" id ="submission_time" />
                                                    <span class="input-group-addon">
                                ...
                                <input list="formats" name="format" id="check_format" class="form-control"> <!--onchange="pushIt(this)"-->
                                <datalist id="formats">
                                    <option value="pdf">
                                    <option value="docx">
                                    <option value="txt">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn success btn-lg" id="file_button1" title="Attach file" disabled>
                                    ...
                                    <button class="btn btn-primary" id="post_btn1" name="assign" onclick="store_attachment(1);">Assign</button>
...
<div class="middle">
      ...
      <div style="display: table-cell;">
       <p class="course-name" style="text-align: center" >
           <?php echo $groupInfo[0]->subject;?>
       </p>
          <p class="course-name"  style="text-align: center; font-size: 17px;">
              <?php echo $groupInfo[0]->section;?>

          </p>
      </div>
    <!--<div style="display: table-cell">
        <p class="course-name1"  style="text-align: center">
            <?php /*echo $groupInfo[0]->section;*/?>
        </p>
    </div>-->
</div>
