    ...
    <div class="mydiv">
        <div class="upper" style="padding-left: 1%;padding-right: 1%">
            ...
            <div style="float: left; height: 100%; width: 50%">
                <?php echo $post->firstName." ".$post->lastName?><br>
        ...
        <?php if ($post->type =='1'){ ?>
            ...
            <?php
                if($due[$assignment][0]->mark_published){ ?>
                    <div class="text-left" style="display: inline;">
                        <a href="http://localhost/SPL/index.php/mark/showToStudent/<?php echo $post->post_id;?>" target="_blank"> <button id = "view_mark<?php echo $post->post_id; ?>" class="btn btn-success" onclick="view_marks(<?php echo $post->post_id?>)">view marks</button> </a>
                    </div>
            <?php }?>
       <div class="text-left" style="display: inline;">
