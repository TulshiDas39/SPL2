...
<div class="main">
    <h1 style="text-align: center">How to create an assignment</h1>
    <br/><br>
    <ol class="check">
        <li>
        ...
        <li>
            Then click plus sign button and then create assignment button.
        </li><br/>
        <li>
            Enter title,description,due date,format and attach files.Then post it to the group.
            You can also view submission of each students in your group.
        </li><br>
