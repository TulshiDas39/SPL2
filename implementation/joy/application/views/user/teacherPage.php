                     ...
                     <div class="modal-dialog" id="post_modal">
                         <div class="modal-content" id="post_content">
                             ...
                             <div class="modal-body">
                                 ...
                                 <textarea typeof="tesxt" placeholder="Share topic" id="topic" name="topic" required></textarea>
                                 <textarea type="text" placeholder= "Share post" id="share" name="share_post" required ></textarea>
                     ...
                     <div class="modal-dialog" id="assign_modal">
                         <div class="modal-content" id="assign_content">
                             ...
                             <div class="modal-body">
                                ...
                                <span id="file_text" name="userFile1">No flie choosen yet</span>
