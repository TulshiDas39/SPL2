    ...
    <div class="mydiv">
        <div class="upper" style="padding-left: 1%;padding-right: 1%">
          ...
          <div style="float: left; height: 100%; width:50%; font-size: large;padding-top: 1%; text-align: right; vertical-align: middle; color: #9fcdff">
              <?php if($post->type =="1"){?>   <?php echo "<script type='text/javascript'>alert('ok')</script>"; echo $type[$assignment]; ?>  <span  class="glyphicon glyphicon-file "></span><?php } ?>
       ...
       <div class="text-right">
            <button class="btn btn-success"><?php echo $button[$assignment] ?></button>
        </div>
        <?php $assignment++; }?>
