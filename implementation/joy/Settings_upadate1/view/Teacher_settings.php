...
2. Its Maximum length is 20 and minimum is 7." >
    ...
    <div class="content5" id="Mydiv5" data-toggle="" title="">
        ...
        <div class="form-group">
            ...
            <input type="text" name="course_name" class="form-control" id="usrname" placeholder="Enter semester name">
        </div>
    ...
    <button class="group_collapsible2" id="group_change_color2">
        Class code  <span style="float: right;" id="hide_edit6">Edit</span>
        <span class="glyphicon glyphicon-pencil pencil" id="hide_icon6" style="float: right"></span>
    </button>
    <div class="content6" id="Mydiv6" data-toggle="" title="">
        <br/>
        <?php echo form_open('')?>
        <div class="form-group">
            <label for="usrname"><span class="glyphicon glyphicon-pencil"></span>Class code:</label>
            <input type="text" name="course_name" class="form-control" id="usrname" placeholder="Enter class code">
        </div>
        <div class="form-group">
        ...
        <div>
            ...
            <button type="button" class="btn btn-default" data-dismiss="modal" id="cancelBtn6">
                <span class="glyphicon glyphicon-remove"></span> Cancel
            </button>
        </div>
        <?php echo  form_close() ?>
...
<script>
    $('.collapsible').click(function(){
        ...
        if(!$('.content6').is(':hidden')) {
            $(".content6").collapse('hide');
            document.getElementById("hide_edit6").style.display = "block";
            document.getElementById("hide_icon6").style.display = "block";
            document.getElementById("group_change_color2").style.display="block";
        }
...
<script>
    $('.group_collapsible2').click(function(){

        $('.content6').collapse('show');

        document.getElementById("hide_edit6").style.display = "none";
        document.getElementById("hide_icon6").style.display = "none";
        document.getElementById("group_change_color2").style.display="none";
