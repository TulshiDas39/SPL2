...
<?php $i=0;$assignment=0; $is_submitted=0;
    ...
    <div class="mydiv" id="div<?php echo $post->post_id?>">
        ...
        <?php if($post->edited == 1) {?> <p id="edited<?php echo $post->post_id;?>" style="display:inline-block;background: #8ba8af;color: white">Edited</p><?php }?>
        <?php if($post->type =='1'){ ?>
        ...
        <p id = "description<?php echo $post->post_id;?>" style="padding-left: 1%;padding-right: 1%;text-align: justify;"><?php echo $post->description ?><br><br></p>
          <?php if($post->type == '1'){
            ...
            ?>  <p id = "format<?php echo $post->post_id?>" style="padding-left: 1%;background: teal;color: white;">Submission Format:<?php echo $myformat;?></p>
        <?php }?>
        <hr style="margin-top:5px;">
        <?php if ($post->type =='1'){ ?>
