...
<div class="newheader">
    ...
    <nav class="navbar nabvar-default" id="navlink">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav nav-pills " id="">
                ...
                <li><a href="#" class="link2" onclick="show_classmates(<?php echo $group_id?>)">Classmates</a></li>
    ...
    <button class="btn success btn-lg " id="techBtn1" onclick="learn()">

        <span class=" glyphicon glyphicon-plus-sign course " data-toggle="tooltip1" data-original-title="Join to another group"></span>
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a href="http://localhost/SPL/index.php/settings/student_settings" target="_blank">Setting</a></li>
                ...
                <div class="modal-dialog" id="menu-modal">
                    <div class="modal-content" id="menu-content">
                        <div class="modal-header">
                            ...
                            <div>
                                <a href="http://localhost/SPL/index.php/student1/load_groups/<?php echo $this->session->userdata('user_id') ?>" target="_blank">
                        ...
                        <div class="modal-footer">
                            <a href="http://localhost/SPL/index.php/settings/student_settings" target="_blank" class="footer-content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding:40px 50px;">
                    <div class="form-group">
                        <label for="code"><span class="glyphicon glyphicon-pencil"></span> Group code</label>
                        <input type="text" class="form-control" id="code" placeholder="Enter group code" required>
                    </div>

                    <button class="btn btn-success btn-block" onclick="send_data()"><span class="glyphicon glyphicon-off" ></span> Submit</button>
...
<script>
    ...
    function send_data() {
        ...
        $.ajax({
            url: 'http://localhost/SPL/index.php/student1/join_group', // point to server-side controller method
            ...
            error: function (response) {
                alert('Can not add to this group');
            }
        });
