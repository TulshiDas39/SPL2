...
<div class="main">
    <h1 style="text-align: center">How to create a group</h1>
    <br/><br>
    <ol class="check">
        <li>
            At first you need to log in with your account. </li><br>
        <li>
            Select teach button to create a group.
        </li><br/>
        <li>
           You should enter course name, course-info,semester and class-code to create a group.
