...
class Teacher1 extends CI_Controller {
    ...
    function enter_group($group_id){
        ...
        if(!empty($pageNo)){
           ...
           /* $this->load->view('teacherPage7');*/
            /*$data['menu'] = $this->load->view('teacherPage7', NULL, TRUE);*/
            /*$this->load->view ('home', $data);*/


            /*  $this->load->view('teacherPage2');*/
