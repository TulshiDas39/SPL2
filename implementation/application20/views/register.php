    ...
    <style type="text/css">
        body{
           /* background-image: url('/ci/ASM/new.png');*/
            background-image: url("http://localhost/SPL/assets/new.png");
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-7" id="form">
            ...
            <form method="post" action="UserRegister" class="formDecorator" id="myform">
                ...
                <div class="form-group" data-toggle="firstnametooltip" title=" 1. This field contains only alpha-numeric characters, underscores or dashes.
               ...
               <!-- <div>
                    <p style="color: red;font-size: 15px;"><?php /*echo */?></p>
                </div>-->
