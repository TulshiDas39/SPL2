...
/*foreach($posts as $post){*/ ?>
    ...
    <div class="mydiv1">
        <div class="upper1" style="padding-left: 1%;padding-right: 1%">

            <div style="float: left; height: 100%; width: 50%">
                <?php echo $firstName." ".$lastName." hare krishna"?><br>
                <?php $date = date_create($date); echo date_format($date,"d-M-Y  g:i:s A ");
                ?>
            </div>
