...
<div class="main">
    ...
    <div class="content" id="Mydiv">
        <br/>
        <?php echo form_open('http://localhost/SPL/index.php/update_settings/update_studentName')?>
...
2. Its Maximum length is 20 and minimum is 3." >
        ...
        <div class="content1" id="Mydiv1" style="width: 400px" data-toggle="emailtooltip" title="Enter a valid email">
            <?php echo form_open('http://localhost/SPL/index.php/update_settings/update_student_email')?>
    ...
    <div class="content2" id="Mydiv2">
        <?php echo form_open('http://localhost/SPL/index.php/update_settings/update_student_password') ?>
...
2. Its Maximum length is 20 and minimum is 7." >
    ...
    <div class="content3" id="Mydiv3">
        <?php echo form_open('http://localhost/SPL/index.php/update_settings/update_student_phoneNumber') ?>
