...
<script type="text/javascript">
    ...
    function loadMoreData(page){
        $.ajax(
            {
                url: 'show_assignments?page=' + page,
                type: "get",
                beforeSend: function()
                {
                    $('.ajax-load').show();
...
*/
    ...
    function send_postId(file_name) {
       ...
       /* alert('in send_postId '+path);
        ...
        $.ajax({
            ...
            url: 'http://localhost/ASM3/index.php/ajaxupload/check_format', // point to server-side controller method
            dataType: 'text', // what to expect back from the server
            cache: false,
            contentType: false,
            processData: false,
            ...
            type: 'post',
            success: function (response) {
           /*     alert(response+'from format check');*/
    ...
    function store(file_name, path) {
        ...
        $.ajax({
            ...
            url: 'http://localhost/ASM3/index.php/ajaxupload/store', // point to server-side controller method
            dataType: 'text', // what to expect back from the server
            cache: false,
            contentType: false,
            processData: false,
