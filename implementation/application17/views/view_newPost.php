...
foreach($posts as $post){ ?>
    ...
    <div class="mydiv" id="div<?php echo $post->post_id?>">
        ...
        <p id="edited<?php echo $post->post_id;?>" style="display:none;background: #8ba8af;color: white">Edited</p>
        <?php if($post->type =='1'){ ?>
        ...
        <?php } ?>
        <h3 id="title<?php echo $post->post_id?>" style="padding-left: 45%"><a href=""><?php  echo $post->title ?></a></h3>
        <p id = "description<?php echo $post->post_id;?>" style="padding-left: 1%;padding-right: 1%"><?php echo $post->description ?></p>
        <hr style="margin-top:5px;">
        <?php if ($post->type =='1'){ ?>
