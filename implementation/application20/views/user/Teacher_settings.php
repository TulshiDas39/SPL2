                ...
                <div class="modal-dialog" id="menu-modal">
                    <div class="modal-content" id="menu-content">
                        <div class="modal-header">
                            ...
                            <div>
                                <a href="http://localhost/SPL/index.php/teacher/load_groups/<?php echo $this->session->userdata('user_id'); ?>">
                                    <span class="glyphicon glyphicon-home" style="font-size: 15px;">&nbsp;Classes</span><br>

                                </a>
                            </div>
                            <div>
                                <a href="http://localhost/SPL/index.php/create_calendar" id="date1">
                        ...
                        <div class="modal-footer">
                            <a href="http://localhost/SPL/index.php/settings/teacher_settings" target="_blank" class="footer-content">
...
<div class="main">
    ...
    <div class="content" id="Mydiv">
        <br/>
        <?php echo form_open('http://localhost/SPL/index.php/update_settings/update_teacher_name')?>
...
2. Its Maximum length is 20 and minimum is 3." >
    ...
    <div class="content1" style="width: 400px"  id="Mydiv1" data-toggle="emailtooltip" title="Enter a valid email">
        <?php echo form_open('http://localhost/SPL/index.php/update_settings/update_teacher_email')?>
    ...
    <div class="content2" id="Mydiv2">
        <?php echo form_open('http://localhost/SPL/index.php/update_settings/update_teacher_password') ?>
        <div class="form-group" style="width: 400px" data-toggle="passwordtooltip"  title=" 1. This field contains only alpha-numeric  characters.
2. Its Maximum length is 20 and minimum is 7." >
    ...
    <div class="content3" id="Mydiv3">
        <?php echo form_open('http://localhost/SPL/index.php/update_settings/update_teacher_phoneNumber') ?>
        <div class="form-group" style="width: 400px" data-toggle="numbertooltip" title="This  field contain only natural numbers:0, 1, 2, 3, etc." >
            <label for="exampleInputPassword" style="color: black"><span class="glyphicon glyphicon-pencil"></span>Phone Number:</label>
            <input type="text" name="phone_number" class="form-control" id="exampleInputPassword" placeholder="phone number" value="<?php /*echo set_value('password'); */?>" />
        </div>
        <div>
            <button type="submit" class="btn btn-primary">
                Save changes
    ...
    <hr>
    <br/>
    <h3 style="font-weight: 700; position: relative; left: 10px;">Assignment Group Settings:</h3>
    <hr>
    <button class="group_collapsible" id="group_change_color">
        Course Name  <span style="float: right;" id="hide_edit4">Edit</span>
        <span class="glyphicon glyphicon-pencil pencil" id="hide_icon4" style="float: right"></span>
    </button>
    <div class="content4" id="Mydiv4" data-toggle="" title="">
        <br/>
        <?php echo form_open('http://localhost/SPL/index.php/update_settings/update_groupName')?>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="course_code" class="form-control" id="usrname" placeholder="Enter group code">
        </div>
        ...
        <div>
            ...
            <button type="button" class="btn btn-default" data-dismiss="modal" id="cancelBtn4">
                <span class="glyphicon glyphicon-remove"></span> Cancel
            </button>
        </div>
        <?php echo  form_close() ?>
    ...
    <button class="group_collapsible1" id="group_change_color1">
        Semester Name  <span style="float: right;" id="hide_edit5">Edit</span>
        <span class="glyphicon glyphicon-pencil pencil" id="hide_icon5" style="float: right"></span>
    </button>
    <div class="content5" id="Mydiv5" data-toggle="" title="">
        <br/>
        <?php echo form_open('http://localhost/SPL/index.php/update_settings/update_semisterName')?>
        <div class="form-group">
            <label for="usrname"><span class="glyphicon glyphicon-pencil"></span>Semester Name:</label>
            <input type="text" name="sem_name" class="form-control" id="usrname" placeholder="Enter semester name">
        </div>
        <div class="form-group">
            <label for="usrname"><span class="glyphicon glyphicon-pencil"></span>Group code:</label>
            <input type="text" name="sem_code" class="form-control" id="usrname" placeholder="Enter group code">
        </div>
        ...
        <div>
            ...
            <button type="button" class="btn btn-default" data-dismiss="modal" id="cancelBtn5">
                <span class="glyphicon glyphicon-remove"></span> Cancel
            </button>
        </div>
        <?php echo  form_close() ?>
...
<script>
    $('.collapsible').click(function(){
        ...
        if(!$('.content4').is(':hidden')) {
            ...
            document.getElementById("hide_edit4").style.display = "block";
            document.getElementById("hide_icon4").style.display = "block";
            document.getElementById("group_change_color").style.display="block";
        }
        if(!$('.content5').is(':hidden')) {
            $(".content5").collapse('hide');
            document.getElementById("hide_edit5").style.display = "block";
            document.getElementById("hide_icon5").style.display = "block";
            document.getElementById("group_change_color1").style.display="block";
        }
...
<script>
    $('.group_collapsible').click(function(){

        $('.content4').collapse('show');

        document.getElementById("hide_edit4").style.display = "none";
        document.getElementById("hide_icon4").style.display = "none";
        document.getElementById("group_change_color").style.display="none";
...
<script>
    $('.group_collapsible1').click(function(){

        $('.content5').collapse('show');

        document.getElementById("hide_edit5").style.display = "none";
        document.getElementById("hide_icon5").style.display = "none";
        document.getElementById("group_change_color1").style.display="none";
